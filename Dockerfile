FROM golang:1.12.7
RUN apt-get update && apt-get install -y python3.8 ruby
...
RUN cd $GOPATH/src/github.com/golang/mock/mockgen && git checkout v1.0.0; go install github.com/golang/mock/mockgen
